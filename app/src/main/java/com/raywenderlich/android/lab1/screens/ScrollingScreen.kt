...
fun MyScrollingScreen(modifier: Modifier=Modifier) {
    Column(modifier = modifier.verticalScroll(rememberScrollState())) {
        BookImage(R.drawable.advancedarchitectureandroid, R.string.android)
        BookImage(R.drawable.kotlinaprentice, R.string.kotlin)
        BookImage(R.drawable.kotlincoroutines, R.string.kotlin_coroutines)
    }
}
