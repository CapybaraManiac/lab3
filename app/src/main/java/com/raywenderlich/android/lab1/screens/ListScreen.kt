...
private val items = listOf(
    BookCategory(
        R.string.android,
        listOf(
            R.drawable.androidaprentice,
            R.drawable.savingdataandroid,
            R.drawable.advancedarchitectureandroid
        )
    ),
    BookCategory(
        R.string.kotlin,
        listOf(
            R.drawable.kotlincoroutines,
            R.drawable.kotlinaprentice
        )
    ),
    BookCategory(
        R.string.swift,
